defmodule IslandsEngine.Board do
  ...
  @spec position_island(any, any, IslandsEngine.Island.t()) :: {:error, :overlapping_island} | map
  ...
  @spec guess(any, IslandsEngine.Coordinate.t()) ::
          {:hit, any, :no_win | :win, map} | {:miss, :none, :no_win, any}
